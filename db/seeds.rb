...
User.create!(name: "satoto", email: "user4@demo.com", password: "444444", profile_image: open("./app/assets/images/icon/icon4.jpeg"), introduction: "最近は早朝テニスにハマっています！都内でいいコートがあれば教えていただきたいです！", is_valid: true)
...
Review.create!(spot_id: 4, user_id: 3, body: "メニューが日替わりなので飽きない。\r\n塩分量は1食約3gとかなり抑えられているため、最初は薄いと感じるかもしれないが、慣れると出汁の味や素材そのものの美味しさを感じられる。", rate: 4)
...
Post.create!(user_id: 1, content: "今日は4km走りました！\r\n段々とペースも上げていきたいです！", category: "運動", start_time: "2021-10-03", created_at: "2021-10-03 19:35")
...
Post.create!(user_id: 1, content: "b-monsterすごくおすすめです！\r\nかなりハードですが楽しさが勝ちます！！", category: "おすすめ", spot_id: 3, start_time: "2021-10-16", created_at: "2021-10-16 23:29")
...
PostComment.create!(post_id: 8, user_id: 3, comment: "美味しそうですね。今度挑戦してみたいと思います。")
PostComment.create!(post_id: 8, user_id: 1, comment: "おしゃれですね〜！すごい！")
PostComment.create!(post_id: 8, user_id: 4, comment: "綺麗！！")
PostComment.create!(post_id: 11, user_id: 5, comment: "私も朝ジム派です。気持ちいいですよね！")
...
Cheer.create!(post_id: 7, user_id: 2)
Cheer.create!(post_id: 7, user_id: 5)
Cheer.create!(post_id: 8, user_id: 1)
Cheer.create!(post_id: 8, user_id: 3)
Cheer.create!(post_id: 8, user_id: 4)
Cheer.create!(post_id: 8, user_id: 5)
Cheer.create!(post_id: 9, user_id: 4)
Cheer.create!(post_id: 10, user_id: 1)
Cheer.create!(post_id: 11, user_id: 1)
Cheer.create!(post_id: 11, user_id: 2)
